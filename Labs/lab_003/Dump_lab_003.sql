CREATE DATABASE  IF NOT EXISTS `lab_work_003` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `lab_work_003`;
-- MySQL dump 10.13  Distrib 8.0.15, for Win64 (x86_64)
--
-- Host: 127.0.0.1    Database: lab_work_003
-- ------------------------------------------------------
...
INSERT INTO `врачи` VALUES (1,'Петров','terapy',101,'11:00-13:00','терапевтическое',1000,201),(2,'Иванов','хирург',102,'13:00-15:00','хирургическое',1500,202),(3,'Сидоров','стоматолог',103,'14:00-16:00','стоматологические',1700,203),(4,'Петров','хирург',104,'13:00-16:00','заведующий',2000,204);
...
CREATE TABLE `журнал` (
  ...
  `name_patient` varchar(45) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `D_dog` int(11) DEFAULT NULL,
...
INSERT INTO `журнал` VALUES (1,'Евдокимов',1,'2020-11-01'),(2,'Гриценко',202,'2020-11-02'),(3,'Валявский',7,'2020-11-03'),(4,'Дейнека',257,'2020-11-05');
...
-- Dump completed on 2021-05-31 14:24:35
